...
Read [claude-md-snippet.md](claude-md-snippet.md). Tailor the placeholders in it to match the target's setup (dev URL, project-specific commands if any) and inject it into the target's `CLAUDE.md`.
